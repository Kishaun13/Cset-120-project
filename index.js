...
//     localStorage.setItem(staffEmail, staffPass)
// }
const orgMenu = `<div class="Breakfast">
<div id="breakfeast-contain">
    <div class="b1 product-item">
        ...
        <div class="products-item-details">
            ...
            <button onclick="addToCart('Croque Madame', 29.00)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
    <div class="b2 product-item">
        ...
        <div class="products-item-details">
            ...
            <button onclick="addToCart('Big French Breakfast', 27.00)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
    <div class="b3 product-item">
        ...
        <div class="products-item-details">
            ...
            <button onclick="addToCart('Fritters', 15.00)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
    <div class="b4 product-item">
        ...
        <div class="products-item-details">
            <p> This super moist dark chocolate mousse combines unsweetened natural cocoa powder and dark cocoa powder for an extra rich flavor.</p>
            <p class="product-price">$35.00</p>
            <button onclick="addToCart('Mousse', 35.00)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
    <div class="b5 product-item">
        ...
        <div class="products-item-details">
            ...
            <button onclick="addToCart('Vanilla Cheesecake', 40.00)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
    <div class="b6 product-item">
        ...
        <div class="products-item-details">
            ...
            <button onclick="addToCart('Donuts', 10.99)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
    <div class="b7  product-item">
        ...
        <div class="products-item-details">
            ...
            <button onclick="addToCart('Plum Cake', 25.00)" class="btn prime-btn product-btn">Add to Order</button>
        </div>
    </div>
</div>
</div><br><br><br><br><br>
...
<div id="products-container" class="items-container">
    <div class="item product-bread">
        ...
        <button class="btn" onclick="addToCart('Bagels', 4.00)" style="text-decoration: none;">Add to Order</button>
    </div>
    <div class="item product-bread">
        ...
        <button class="btn" onclick="addToCart('Fresh Rye bread', 12.00)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-beverage">
        ...
        <div class="shop-item-price">$4.00</div>
        <button class="btn" onclick="addToCart('Affogato el Cafe', 4.00)" style="text-decoration: none;">Add to
            Order</a>
    </div>
    <div class="item product-beverage">
        ...
        <div class="shop-item-price">$12.00</div>
        <button class="btn" onclick="addToCart('Frozen Cappuccino', 12.00)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-beverage">
        ...
        <button class="btn" onclick="addToCart('Cappuccino', 9.00)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-beverage">
        ...
        <button class="btn" onclick="addToCart('Chamomile Tea', 5.00)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-beverage">
        ...
        <div class="shop-item-price">$5.00</div>
        <button class="btn" onclick="addToCart('Black Coffee with fresh cream', 5.00)" style="text-decoration: none;">Add to Order</button>
    </div>
    <div class="item product-beverage">
        ...
        <div class="shop-item-price">$12.00</div>
        <button class="btn" onclick="addToCart('Black Coffee French Press', 12.00)" style="text-decoration: none;">Add to Order</button>
    </div>
    <div class="item product-beverage">
        ...
        <button class="btn" onclick="addToCart('Expresso Shot', 7.49)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    ...
    <div class="item product-dessert"><img class="shop-item-image" width="200" src="images/products/cream-puff2.jpeg" alt="" srcset="">
        ...
        <button class="btn" onclick="addToCart('Cream-Puff', 5.49)" style="text-decoration: none;">Add to
            Order</button>
    ...
    <div class="item product-dessert"><img class="shop-item-image" width="200" src="images/products/apple-strudel.jpeg" alt="" srcset="">
        ...
        <button class="btn" onclick="addToCart('Apple Strudel', 14.49)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-dessert"><img class="shop-item-image" width="200" src="images/products/cup-cakes-2.jpeg" alt="" srcset="">
        ...
        <div class="shop-item-price">$5.49</div>
        <button class="btn" onclick="addToCart('Cupcake', 5.49)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-dessert"><img class="shop-item-image" width="200" src="images/products/tart-coco2.jpeg" alt="" srcset="">
        ...
        <div>$9.99</div>
        <button class="btn" onclick="addToCart('Chocolate Tart', 9.99)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-dessert"><img class="shop-item-image" width="200" src="images/products/macaroons.jpeg" alt="" srcset="">
        ...
        <button class="btn" onclick="addToCart('Macaroons', 34.49)" style="text-decoration: none;">Add to
            Order</button>
    </div>
    <div class="item product-dessert"><img class="shop-item-image" width="200" src="images/products/meringue.jpeg" alt="" srcset="">
        ...
        <button class="btn" onclick="addToCart('Meringue Cookies', 29.99)" style="text-decoration: none;">Add to
            Order</button>
    </div>
</div>
</section>`
